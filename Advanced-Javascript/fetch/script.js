...
searchButton.addEventListener("click", function () {
    ...
    fetch("http://www.omdbapi.com/?apikey=d76044a2&s=" + inputKeyword.value)
        ...
        .then(response => {
            ...
            movieDetail.forEach(modal => {
                modal.addEventListener("click", function () {
                    fetch("http://www.omdbapi.com/?apikey=d76044a2&i=" + this.getAttribute("data-imdbid"))
                        .then(response => response.json())
                        .then(response => {
