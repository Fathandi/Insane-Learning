...
function getMovies(keyword) {
    return fetch("http://www.omdbapi.com/?apikey=d76044a2&s=" + keyword)
        //! error handling pada network
        .then(response => {
            if (!response.ok) {
...
function getDetailMovies(imdbid) {
    return fetch("http://www.omdbapi.com/?apikey=d76044a2&i=" + imdbid)
